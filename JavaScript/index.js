...
const scoreP3 = document.querySelector(".replies .reply-one .score-cont .score");
const scoreP4 = document.querySelector(".replies .reply-two .score-cont .score");
...
const replyCommentP1 = document.querySelector(".replies .reply-one .comment-text");
const replyCommentSpan1 = document.querySelector(".replies .reply-one .comment-text .replied-to");
const replyCommentP2 = document.querySelector(".replies .reply-two .comment-text");
const replyCommentSpan2 = document.querySelector(".replies .reply-two .comment-text .replied-to");
